    ...
    <div className=" w-full flex flex-col justify-center items-center ">
        ...
        <div className=" z-50 flex mb-36 lg:mb-52">
            <div className="card w-[344px] md:w-[410px] lg:w-[800px] h-[250px] lg:h-[190px] flex gap-[5px] p-[.4em]">
                <div className="group flex-1 h-full overflow-hidden rounded-full cursor-pointer hover:rounded-md lg:mx-1 transition-all duration-300 bg-antonSalmon-darksalmon hover:bg-antonSecondary flex justify-center items-center hover:flex-[8]">
                <span className="group-hover:min-w-[14em] p-[.5em] text-center group-hover:text-left group-hover:p-5 transform -rotate-90 group-hover:rotate-0 transition-all duration-500 text-antonOrange tracking-[.1em] group-hover:h-full group-hover:transition-all group-hover:duration-1000">
                ...
                <div className="group flex-1 overflow-hidden rounded-full cursor-pointer hover:rounded-md mx-1 transition-all duration-500 bg-antonSalmon-darksalmon hover:bg-antonSecondary flex justify-center items-center hover:flex-[8]">
                    <span className="group-hover:min-w-[14em] p-[.5em] text-center group-hover:text-left group-hover:p-5 transform -rotate-90 group-hover:rotate-0 transition-all duration-500 text-antonOrange tracking-[.1em] group-hover:h-full group-hover:transition-all group-hover:duration-1000">
                        <div className=" flex text-antonTextWhite tracking-[.2em] justify-center lg:text-xl">
                            ELIEL
                        </div>
